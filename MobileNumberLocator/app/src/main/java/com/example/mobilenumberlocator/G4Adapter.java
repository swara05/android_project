...
public class G4Adapter extends RecyclerView.Adapter<G4Adapter.ViewHolder> {

    private List<ModalTopup> userList;
    Context context;

    public G4Adapter(List<ModalTopup> userList, Context context) {
    ...
    @NonNull
    @Override
    public G4Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_popup,parent,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull G4Adapter.ViewHolder holder, int position) {
