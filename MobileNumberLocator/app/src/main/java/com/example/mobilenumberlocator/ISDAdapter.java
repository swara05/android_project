...
public class ISDAdapter extends RecyclerView.Adapter<ISDAdapter.ViewHolder> {

    private List<ModalTopup> userList;
    Context context;

    public ISDAdapter(List<ModalTopup> userList, Context context) {
    ...
    @NonNull
    @Override
    public ISDAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_popup,parent,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ISDAdapter.ViewHolder holder, int position) {
