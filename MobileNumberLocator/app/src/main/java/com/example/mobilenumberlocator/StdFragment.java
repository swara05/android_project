...
public class StdFragment extends Fragment {
    ...
    private void initData() {
        ...
        if(name.equals("Airtel") || name.equals("Jio") || name.equals("Vodafone") || name.equals("Idea")){
...
//        userList.add(new ModalTopup("3359","Enjoy unlimited Local, STD & Roaming calls on any network, daily 2.5GB & 100 SMS | Pack Valid for 365 days","1 year"));
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        stdAdapter = new StdAdapter(userList,getContext());
        recycler.setAdapter(stdAdapter);
