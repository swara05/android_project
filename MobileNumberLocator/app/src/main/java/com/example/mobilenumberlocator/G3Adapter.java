...
public class G3Adapter extends RecyclerView.Adapter<G3Adapter.ViewHolder> {

    private List<ModalTopup> userList;
    Context context;

    public G3Adapter(List<ModalTopup> userList, Context context) {
    ...
    @NonNull
    @Override
    public G3Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_popup,parent,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull G3Adapter.ViewHolder holder, int position) {
