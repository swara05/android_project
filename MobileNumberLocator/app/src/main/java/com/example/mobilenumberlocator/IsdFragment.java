...
public class IsdFragment extends Fragment {
    ...
    private void initData() {
        ...
        if(name.equals("Airtel")) {
            if (sname.equals("Assam") || sname.equals("Chennai") || sname.equals("Delhi NCR") || sname.equals("Gujarat") || sname.equals("Himachal Pradesh") || sname.equals("Jammu Kashmir")) {
                ...
                userList.add(new ModalTopup("18", "Enjoy ISD calling at discounted rates for 28 days | For country wise tariff visit www.airtel.in", "28 days"));
...
//        userList.add(new ModalTopup("3359","Enjoy unlimited Local, STD & Roaming calls on any network, daily 2.5GB & 100 SMS | Pack Valid for 365 days","1 year"));
            ...
            if(sname.equals("Assam") || sname.equals("Bihar") || sname.equals("Hariyana")|| sname.equals("Jammu Kashmir")){
                userList.add(new ModalTopup("","",""));
            }else if(name.equals("Chennai")|| sname.equals("Delhi NCR") ||sname.equals("Gujarat") || sname.equals("Himachal Pradesh")){
                userList.add(new ModalTopup("501","ISD Talktime: Rs | 424.58 and 5 ISD SMS, Talktime can be used only for making ISD calls and ISD SMS while ","28 days"));
            }
        }else if(name.equals("Vodafone")){
            if (sname.equals("Assam")  || sname.equals("Jammu Kashmir")) {

                userList.add(new ModalTopup("18", "US & Canada: Unlimited, Valid for 1 hour", "1 hour"));
            }else if(sname.equals("Bihar") || sname.equals("Hariyana") || sname.equals("Delhi NCR")|| sname.equals("Gujarat")|| sname.equals("Himachal Pradesh") ){
                userList.add(new ModalTopup("","",""));
            }else if( sname.equals("Chennai") ){
                userList.add(new ModalTopup("18", "Calling to the US/Canada.T&Cs apply | Refer https://shop.vodafone.in/shop /prepaid/Prepaid_SuperHour_t&c.pdf", "1 hour"));
                userList.add(new ModalTopup("22", "UAE @ Rs.12.0 p/sec | Saudi Arabia @ Rs.12.0 p/sec | Kuwait @ Rs.12.0 p/ sec | Qatar @ Rs.12.0 p/sec | Bahrai", "28 days"));
            }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_isd, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        isdAdapter = new ISDAdapter(userList,getContext());
        recycler.setAdapter(isdAdapter);
