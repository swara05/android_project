...
public class SmsFragment extends Fragment {
    ...
    if(name.equals("Airtel")){
        if(sname.equals("Assam")  || sname.equals("Chennai") || sname.equals("Delhi NCR")||sname.equals("Gujarat")||sname.equals("Jammu Kashmir")
           || sname.equals("Bihar") ||sname.equals("Himachal Pradesh")||sname.equals("Hariyana")){
        ...
        if(sname.equals("Assam") || sname.equals("Bihar")||sname.equals("Hariyana")||sname.equals("Jammu Kashmir")){
            userList.add(new ModalTopup("","",""));
        }else if(sname.equals("Chennai")|| sname.equals("Delhi NCR")||sname.equals("Gujarat")||sname.equals("Himachal Pradesh")){
            ...
            userList.add(new ModalTopup("575", "Unlimited Packs without Wifi Calling Benefits: Voice (outgoing local calls + outgoing calls to India) 100", "1 days"));
            userList.add(new ModalTopup("2875", "Unlimited Packs without Wifi Calling Benefits: Voice (outgoing local calls + outgoing calls to India) 100", "7 days"));
            userList.add(new ModalTopup("5751", "Unlimited Packs without Wifi Calling Benefits: Voice (outgoing local calls + outgoing calls to India) 1500 ", "28 days"));
        ...
        if(sname.equals("Assam") || sname.equals("Chennai")|| sname.equals("Delhi NCR")||sname.equals("Gujarat")||sname.equals("Himachal Pradesh")||sname.equals("Jammu Kashmir")){
            userList.add(new ModalTopup("12","SMS: 120 SMS","10 days"));
            userList.add(new ModalTopup("26","SMS: 250 SMS","28 days"));
            userList.add(new ModalTopup("36","SMS: 350 SMS","28 days"));
...
//        userList.add(new ModalTopup("3359","Enjoy unlimited Local, STD & Roaming calls on any network, daily 2.5GB & 100 SMS | Pack Valid for 365 days","1 year"));
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        smsAdapter = new SmsAdapter(userList,getContext());
