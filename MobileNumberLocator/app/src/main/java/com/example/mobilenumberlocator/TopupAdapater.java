...
public class TopupAdapater extends RecyclerView.Adapter<TopupAdapater.ViewHolder> {

    private List<ModalTopup> userList;

    Context context;

    public TopupAdapater(List<ModalTopup> userList, Context context) {
    ...
    @NonNull
    @Override
    public TopupAdapater.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_popup,parent,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull TopupAdapater.ViewHolder holder, int position) {
