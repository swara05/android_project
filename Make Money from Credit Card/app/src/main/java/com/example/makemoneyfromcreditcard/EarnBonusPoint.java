...
public class EarnBonusPoint extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_earn_bonus_point);
    ...
    private void refreshAd2() {
        ...
        if (AdmobAdManager.getInstance().isAdLoadProcessing2) {
            ...
            AdmobAdManager.getInstance().adEventListener = new AdEventListener() {
                ...
                public void onAdLoaded(Object object) {
                    AdmobAdManager.getInstance().populateNativeAdView( EarnBonusPoint.this, native_ad_layout2, (com.google.android.gms.ads.nativead.NativeAd)object);
                    AdmobAdManager.getInstance().LoadNativeAd(EarnBonusPoint.this, str2);
        ...
        else
        {
            if(AdmobAdManager.getInstance().mNativeAd2 != null)
            {
                ...
                AdmobAdManager.getInstance().populateNativeAdView2(EarnBonusPoint.this, native_ad_layout2, AdmobAdManager.getInstance().mNativeAd2);
                AdmobAdManager.getInstance().LoadNativeAd2(EarnBonusPoint.this, str2);
            }
        }
    }
    ...
    private void refreshAd() {
        if (AdmobAdManager.getInstance().isAdLoadProcessing) {
            ...
            AdmobAdManager.getInstance().adEventListener = new AdEventListener() {
                @Override
                public void onAdLoaded(Object object) {
                    AdmobAdManager.getInstance().populateNativeAdView( EarnBonusPoint.this, native_ad_layout, (com.google.android.gms.ads.nativead.NativeAd)object);
                    AdmobAdManager.getInstance().LoadNativeAd(EarnBonusPoint.this, str2);
                    AdmobAdManager.getInstance().adEventListener = null;
                }
        ...
        else
        {
            ...
            {
                //  Toast.makeText( , "loads2", Toast.LENGTH_SHORT ).show();
                AdmobAdManager.getInstance().populateNativeAdView(EarnBonusPoint.this, native_ad_layout, AdmobAdManager.getInstance().mNativeAd);
                AdmobAdManager.getInstance().LoadNativeAd(EarnBonusPoint.this, str2);
            }
        }
    }
    ...
    private void inflateAd2(com.facebook.ads.NativeAd nativeAd) {
        ...
        LayoutInflater inflater = LayoutInflater.from(EarnBonusPoint.this);
        ...
        AdOptionsView adOptionsView = new AdOptionsView(EarnBonusPoint.this, nativeAd, nativeAdLayout2);
    ...
    private void inflateAd(com.facebook.ads.NativeAd nativeAd) {
        ...
        // Add the AdOptionsView
        LinearLayout adChoicesContainer = findViewById(R.id.ad_choices_container1);
        AdOptionsView adOptionsView = new AdOptionsView(EarnBonusPoint.this, nativeAd, nativeAdLayout1);
        adChoicesContainer.removeAllViews();
        adChoicesContainer.addView(adOptionsView, 0);
