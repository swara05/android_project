...
public class Sliderr extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sliderr);
                ...
                if (str1.equals("g")) {
                    if (isNetworkAvailable()) {
                        if (!str4.equals("")) {
                            ...
                            progress = ProgressDialog.show(Sliderr.this, Sliderr.this.getString(R.string.app_name),
                                    Sliderr.this.getString(R.string.ads_loader), true);


                            AdRequest adRequest = new AdRequest.Builder().build();

                            InterstitialAd.load(Sliderr.this, str4, adRequest,
                                    new InterstitialAdLoadCallback() {
                                        ...
                                        public void onAdLoaded(@NonNull InterstitialAd interstitialAd) {
                                            ...
                                            interstitialAd.show(Sliderr.this);
                                            interstitialAd.setFullScreenContentCallback(
                                                    new FullScreenContentCallback() {
                                                        ...
                                                        public void onAdDismissedFullScreenContent() {
                                                            ...
                                                            Intent intent = new Intent(Sliderr.this, SliderTwo.class);
                    ...
                    if (isNetworkAvailable()) {
                        if (!str4.equals("")) {
                            ...
                            final ProgressDialog progress;
                            progress = ProgressDialog.show(Sliderr.this,
                            ...
                            interstitialAd = new com.facebook.ads.InterstitialAd(Sliderr.this, str4);
        ...
        before.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(Sliderr.this,Overview.class);
                startActivity(i);
            }
        });
    }
        ...
        if(str1.equals("g") )
        {
            ...
            if (AdmobAdManager.getInstance().isAdLoadProcessing) {
                ...
                AdmobAdManager.getInstance().adEventListener = new AdEventListener() {
                    ...
                    public void onAdLoaded(Object object) {
                        AdmobAdManager.getInstance().populateNativeAdView( Sliderr.this, native_ad_layout, (com.google.android.gms.ads.nativead.NativeAd)object);
                        AdmobAdManager.getInstance().LoadNativeAd(Sliderr.this, str2);
            ...
            else
            {
                if(AdmobAdManager.getInstance().mNativeAd != null)
                {
                    ...
                    AdmobAdManager.getInstance().populateNativeAdView(Sliderr.this, native_ad_layout, AdmobAdManager.getInstance().mNativeAd);
                    AdmobAdManager.getInstance().LoadNativeAd(Sliderr.this, str2);
                }
            }
    ...
    private void inflateAd(com.facebook.ads.NativeAd nativeAd) {
        ...
        LayoutInflater inflater = LayoutInflater.from(Sliderr.this);
        ...
        AdOptionsView adOptionsView = new AdOptionsView(Sliderr.this, nativeAd, nativeAdLayout1);
