...
import static com.example.admob.Splash_screen.str1;
import static com.example.admob.Splash_screen.str2;
import static com.example.admob.Splash_screen.str3;
import static com.example.admob.Splash_screen.str4;
import static com.example.admob.Splash_screen.str7;
...
import com.example.admob.Utils2.AdEventListener;
...
public class SliderThree extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        slider3_next = findViewById(R.id.slider3_next);
        ...
        slider3_next.setOnClickListener(new View.OnClickListener() {
            @Override
                ...
                if (str1.equals("g")) {
                    if (isNetworkAvailable()) {
                        if (!str4.equals("")) {
                            ...
                            progress = ProgressDialog.show(SliderThree.this, SliderThree.this.getString(R.string.app_name),
                                    SliderThree.this.getString(R.string.ads_loader), true);


                            AdRequest adRequest = new AdRequest.Builder().build();

                            InterstitialAd.load(SliderThree.this, str4, adRequest,
                                    new InterstitialAdLoadCallback() {
                                        ...
                                        public void onAdLoaded(@NonNull InterstitialAd interstitialAd) {
                                            ...
                                            interstitialAd.show(SliderThree.this);
                                            interstitialAd.setFullScreenContentCallback(
                                                    new FullScreenContentCallback() {
                                                        ...
                                                        public void onAdDismissedFullScreenContent() {
                                                            ...
                                                            Intent intent = new Intent(SliderThree.this, MainActivity.class);
                    ...
                    if (isNetworkAvailable()) {
                        if (!str4.equals("")) {
                            ...
                            final ProgressDialog progress;
                            progress = ProgressDialog.show(SliderThree.this,
                            ...
                            interstitialAd = new com.facebook.ads.InterstitialAd(SliderThree.this, str4);
        ...
        before2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(SliderThree.this,SliderTwo.class);
                startActivity(i);
            }
        });
        ...
        if(str1.equals("g") )
        {
            ...
            if (AdmobAdManager.getInstance().isAdLoadProcessing) {
                ...
                AdmobAdManager.getInstance().adEventListener = new AdEventListener() {
                    ...
                    public void onAdLoaded(Object object) {
                        AdmobAdManager.getInstance().populateNativeAdView( SliderThree.this, native_ad_layout, (com.google.android.gms.ads.nativead.NativeAd)object);
                        AdmobAdManager.getInstance().LoadNativeAd(SliderThree.this, str2);
            ...
            else
            {
                if(AdmobAdManager.getInstance().mNativeAd != null)
                {
                    ...
                    AdmobAdManager.getInstance().populateNativeAdView(SliderThree.this, native_ad_layout, AdmobAdManager.getInstance().mNativeAd);
                    AdmobAdManager.getInstance().LoadNativeAd(SliderThree.this, str2);
                }
            }
    ...
    private void inflateAd(com.facebook.ads.NativeAd nativeAd) {
        ...
        LayoutInflater inflater = LayoutInflater.from(SliderThree.this);
        ...
        AdOptionsView adOptionsView = new AdOptionsView(SliderThree.this, nativeAd, nativeAdLayout1);
