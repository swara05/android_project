...
import static com.example.bloodpressure.SplashScreen.str4;
import static com.example.bloodpressure.SplashScreen.str7;
import static com.example.bloodpressure.Utils2.Global.isNetworkAvailable;
...
public class SliderThree extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                                                ...
                                                interstitialAd.setFullScreenContentCallback(
                                                        new FullScreenContentCallback() {
                                                            ...
                                                            public void onAdDismissedFullScreenContent() {
                                                                ...
                                                                Intent intent = new Intent(SliderThree.this, SliderTwo.class);
                                                            ...
                                                            public void onAdFailedToShowFullScreenContent(AdError adError) {
                                                                ...
                                                                Intent intent = new Intent(SliderThree.this, SliderThree.class);
                                                                startActivity(intent);
                                                                key = false;
        ...
        before1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(SliderThree.this,Sliderr.class);
                startActivity(i);
            }
        });
