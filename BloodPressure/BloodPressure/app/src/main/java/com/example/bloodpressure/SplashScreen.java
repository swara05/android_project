...
import com.example.bloodpressure.Pojo.Data;
import com.example.bloodpressure.Pojo.Devtesting;
import com.example.bloodpressure.Utils2.AdmobAdManager;
import com.example.bloodpressure.Utils2.Global;
import com.example.bloodpressure.Utils2.GlobalRetro;
...
public class SplashScreen extends AppCompatActivity {
            ...
            new Handler().postDelayed(new Runnable() {
                public void run() {
                    ...
                    if (str_rating.equals("1")){
                        ...
                        finish();
                    }else if (str_extra.equals("1")){
                        Intent intent1 = new Intent(SplashScreen.this, Language.class);
    ...
    private void getAds() {
        RestAdsApi restApi = GlobalRetro.initRetrofit1(SplashScreen.this);
            ...
            public void onResponse(Call<Devtesting> call, retrofit2.Response<Devtesting> response) {
                ...
                if (response.body() != null) {
                    ...
                    if (response.body().getStatus().equals("success")) {
                        ...
                        AdmobAdManager.getInstance().LoadNativeAd(SplashScreen.this, str2);
                      //  AdmobAdManager.getInstance().LoadNativeAd2(SplashScreen.this, str5);
//                        AdmobAdManager.getInstance().LoadNativeAd3(SplashScreen.this, str5);
            ...
            public void onFailure(Call<Devtesting> call, Throwable t) {
                ...
                GlobalRetro.showToast(SplashScreen.this, "Something went to wrong");
            }
        });
    }
...
// Ads Over
    ...
    private void InitAppOpenAd() {
        ...
        AppOpenAd.load(SplashScreen.this, str6, request,
