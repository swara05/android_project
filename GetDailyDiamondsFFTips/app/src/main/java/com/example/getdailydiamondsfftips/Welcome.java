            ...
            public void onClick(View view) {
                ...
                if (!key) {
                    ...
                    if(Splash_screen.str_extra.equals("1")){
                        Intent i = new Intent(Welcome.this, com.example.getdailydiamondsfftips.LanguageActivity.class);
                        startActivity(i);
                        key = false;
                    }else{
                ...
                Intent lang = new Intent(Welcome.this, com.example.getdailydiamondsfftips.LanguageActivity.class);
                startActivity(lang);
            }
        });
