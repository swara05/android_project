...
public class VehicleDiamonds extends AppCompatActivity {

    ImageView back,vehicleimg;
    TextView vehicleheading,vehicledetails,vehicleinfo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vehicle_diamonds);

        back = findViewById(R.id.back);
        vehicleimg = findViewById(R.id.vehicleimg);
        vehicleheading = findViewById(R.id.vehicleheading);
        ...
        if(v.equals("Motorbike Vehicles")){
            vehicleimg.setImageResource(R.drawable.motor);
            vehicledetails.setText(R.string.motor_des);
            vehicleinfo.setText(R.string.motor_info);
        }
        else if(v.equals("Mini Cooper Vehicles")){
            vehicleimg.setImageResource(R.drawable.motor);
            vehicledetails.setText(R.string.motor_des);
            vehicleinfo.setText(R.string.motor_info);
        }else if(v.equals("Monster Truk Vehicles")){
            vehicleimg.setImageResource(R.drawable.motor);
            vehicledetails.setText(R.string.motor_des);
            vehicleinfo.setText(R.string.motor_info);
        }else if(v.equals("Helicopter Vehicles")){
            vehicleimg.setImageResource(R.drawable.motor);
            vehicledetails.setText(R.string.motor_des);
            vehicleinfo.setText(R.string.motor_info);
        }else if(v.equals("Amphibious Vehicles")){
            vehicleimg.setImageResource(R.drawable.amphi);
            vehicledetails.setText(R.string.amphibious_des);
            vehicleinfo.setText(R.string.amphibious_info);
        }else if(v.equals("Police Car Vehicles")){
            vehicleimg.setImageResource(R.drawable.motor);
            vehicledetails.setText(R.string.motor_des);
            vehicleinfo.setText(R.string.motor_info);
        }else if(v.equals("Jeep Vehicles")){
            vehicleimg.setImageResource(R.drawable.motor);
            vehicledetails.setText(R.string.motor_des);
            vehicleinfo.setText(R.string.motor_info);
        }else if(v.equals("Pickup Truck Vehicles")){
            vehicleimg.setImageResource(R.drawable.motor);
            vehicledetails.setText(R.string.motor_des);
            vehicleinfo.setText(R.string.motor_info);
        }else if(v.equals("Sport Car Vehicles")){
            vehicleimg.setImageResource(R.drawable.motor);
            vehicledetails.setText(R.string.motor_des);
            vehicleinfo.setText(R.string.motor_info);
        }else if(v.equals("Tuk-Tuk Vehicles")){
            vehicleimg.setImageResource(R.drawable.motor);
            vehicledetails.setText(R.string.motor_des);
            vehicleinfo.setText(R.string.motor_info);
        }
    ...
    private void refreshAd2() {
        ...
        if (AdmobAdManager.getInstance().isAdLoadProcessing2) {
            ...
            AdmobAdManager.getInstance().adEventListener = new AdEventListener() {
                ...
                public void onAdLoaded(Object object) {
                    AdmobAdManager.getInstance().populateNativeAdView( VehicleDiamonds.this, native_ad_layout2, (com.google.android.gms.ads.nativead.NativeAd)object);
                    AdmobAdManager.getInstance().LoadNativeAd(VehicleDiamonds.this, str2);
        ...
        else
        {
            if(AdmobAdManager.getInstance().mNativeAd2 != null)
            {
                ...
                AdmobAdManager.getInstance().populateNativeAdView2(VehicleDiamonds.this, native_ad_layout2, AdmobAdManager.getInstance().mNativeAd2);
                AdmobAdManager.getInstance().LoadNativeAd2(VehicleDiamonds.this, str2);
            }
        }
    }
    ...
    private void refreshAd() {
        if (AdmobAdManager.getInstance().isAdLoadProcessing) {
            ...
            AdmobAdManager.getInstance().adEventListener = new AdEventListener() {
                @Override
                public void onAdLoaded(Object object) {
                    AdmobAdManager.getInstance().populateNativeAdView( VehicleDiamonds.this, native_ad_layout, (com.google.android.gms.ads.nativead.NativeAd)object);
                    AdmobAdManager.getInstance().LoadNativeAd(VehicleDiamonds.this, str2);
                    AdmobAdManager.getInstance().adEventListener = null;
                }
        ...
        else
        {
            ...
            {
                //  Toast.makeText( , "loads2", Toast.LENGTH_SHORT ).show();
                AdmobAdManager.getInstance().populateNativeAdView(VehicleDiamonds.this, native_ad_layout, AdmobAdManager.getInstance().mNativeAd);
                AdmobAdManager.getInstance().LoadNativeAd(VehicleDiamonds.this, str2);
            }
        }
    }
    ...
    private void inflateAd2(com.facebook.ads.NativeAd nativeAd) {
        ...
        LayoutInflater inflater = LayoutInflater.from(VehicleDiamonds.this);
        ...
        AdOptionsView adOptionsView = new AdOptionsView(VehicleDiamonds.this, nativeAd, nativeAdLayout2);
    ...
    private void inflateAd(com.facebook.ads.NativeAd nativeAd) {
        ...
        // Add the AdOptionsView
        LinearLayout adChoicesContainer = findViewById(R.id.ad_choices_container1);
        AdOptionsView adOptionsView = new AdOptionsView(VehicleDiamonds.this, nativeAd, nativeAdLayout1);
        adChoicesContainer.removeAllViews();
        adChoicesContainer.addView(adOptionsView, 0);
