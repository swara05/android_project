...
import com.example.getdailydiamondsfftips.Api.RestAdsApi;
import com.example.getdailydiamondsfftips.Pojo.Counter.Counter;
import com.example.getdailydiamondsfftips.Pojo.Data;
import com.example.getdailydiamondsfftips.Pojo.Devtesting;
import com.example.getdailydiamondsfftips.Utils2.AdmobAdManager;
import com.example.getdailydiamondsfftips.Utils2.Global;
import com.example.getdailydiamondsfftips.Utils2.GlobalRetro;
            ...
            new Handler().postDelayed(new Runnable() {
                public void run() {
                    ...
                    if (str_rating.equals("1")){
                        ...
                        Intent intent1 = new Intent(Splash_screen.this, LanguageActivity.class);
            ...
            public void onResponse(Call<Devtesting> call, retrofit2.Response<Devtesting> response) {
                ...
                if (response.body() != null) {
                    ...
                    if (response.body().getStatus().equals("success")) {
                        ...
                        AdmobAdManager.getInstance().LoadNativeAd2(Splash_screen.this, str5);
                        AdmobAdManager.getInstance().LoadNativeAd3(Splash_screen.this, str2);
                        AdmobAdManager.getInstance().LoadNativeAd4(Splash_screen.this, str2);
