...
import com.example.getdailydiamondsfftips.R;
...
public class AdmobAdManager {
    ...
    public boolean isAdLoadProcessing3 = false;
    public boolean isAdLoadProcessing4 = false;
    public NativeAd mNativeAd3;
    public boolean isAdLoadProcessing2 = false;
    public NativeAd mNativeAd2;
    public NativeAd mNativeAd4;
    ...
    public void LoadNativeAd2(final Context context, String nativeAdID) {
        AdLoader.Builder builder = new AdLoader.Builder(context, nativeAdID);
        isAdLoadProcessing = true;
        builder.forNativeAd(unifiedNativeAd -> {
            mNativeAd2 = unifiedNativeAd;
            if (adEventListener != null) {
                adEventListener.onAdLoaded(unifiedNativeAd);
            }
            isAdLoadProcessing = false;
    ...
    public void LoadNativeAd3(final Context context, String nativeAdID) {
        AdLoader.Builder builder = new AdLoader.Builder(context, nativeAdID);
        isAdLoadProcessing3 = true;
        builder.forNativeAd(unifiedNativeAd -> {
            mNativeAd3 = unifiedNativeAd;
            if (adEventListener != null) {
                adEventListener.onAdLoaded(unifiedNativeAd);
            }
            isAdLoadProcessing3 = false;
        }).withAdListener(new AdListener() {
            @Override
            public void onAdClosed() {
                super.onAdClosed();
    ...
    public void LoadNativeAd4(final Context context, String nativeAdID) {
        AdLoader.Builder builder = new AdLoader.Builder(context, nativeAdID);
        isAdLoadProcessing4 = true;
        builder.forNativeAd(unifiedNativeAd -> {
            mNativeAd4 = unifiedNativeAd;
            if (adEventListener != null) {
                adEventListener.onAdLoaded(unifiedNativeAd);
            }
            isAdLoadProcessing4 = false;
        }).withAdListener(new AdListener() {
            @Override
            public void onAdClosed() {
                super.onAdClosed();
    ...
    public void populateNativeAdView2(Context context, FrameLayout frameLayout, NativeAd nativeAd) {
        if (isNetworkAvailable(context)) {
            LayoutInflater inflater = LayoutInflater.from(context);
            NativeAdView adView = (NativeAdView) inflater.inflate( R.layout.ad_unit2, null);
    ...
    public void populateNativeAdView3(Context context, FrameLayout frameLayout, NativeAd nativeAd) {
        if (isNetworkAvailable(context)) {
            LayoutInflater inflater = LayoutInflater.from(context);
            NativeAdView adView = (NativeAdView) inflater.inflate( R.layout.ad_unit2, null);
    ...
    public void populateNativeAdView4(Context context, FrameLayout frameLayout, NativeAd nativeAd) {
        if (isNetworkAvailable(context)) {
            LayoutInflater inflater = LayoutInflater.from(context);
            NativeAdView adView = (NativeAdView) inflater.inflate( R.layout.ad_unit2, null);
